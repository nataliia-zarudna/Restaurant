...
import sirobaba.testtask.restaurant.controller.ApplicationContextProvider;
...
public class SqliteUtils {
    ...
    public static JdbcTemplate getJdbcTemplate() {
        ...
        if(jdbcTemplate == null) {
            DataSource dataSource = ApplicationContextProvider.getApplicationContext().getBean("sqliteDataSource", DataSource.class);
