...
public interface OrderDAO {
    ...
    void addDishToOrdered(int orderID, int userID, int dishID) throws ModelException;

    void removeDishFromOrdered(int orderID, int userID, int dishID) throws ModelException;
